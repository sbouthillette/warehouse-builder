...
-- one-time verification code sent by api/auth/login.js and checked by
-- api/auth/verify.js. This is what stops a bot (or a stranger typing in
...
-- around after it's used or expires — api/auth/verify.js deletes the row
