// lib/authPages.js — shared HTML for the sign-in flow (api/access/login.js
// step 1: email -> code sent; api/access/verify.js step 2: code -> signed
...
<style>${CARD_STYLE}</style>
  ...
  <div class="auth-card">
    ...
    <p class="auth-footnote">Code expires in 10 minutes. <a href="/api/access/login?next=${encodeURIComponent(next)}">Use a different email</a></p>
  </div>
</body></html>`;
}
